                        ...
                        <div class="card">
                                <div class="card-header">
                                        <form class="form-header" action="" method="POST">
                                                <input class="au-input au-input--xl" type="text" name="search" placeholder="Enter ID Number" />
                                                <button class="au-btn--submit" type="submit" name="search_btn">
