...
<head>
    ...
    <!-- Title Page-->
    <title>DexApp - Update List</title>
            ...
            <div class="main-content"> 
                    ...
                    <div class="IDAdder">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="updatelist.php" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="email" id="hf_email" name="hf_email" placeholder="Enter Email" class="form-control">
                                            </div>
                                        </div>
